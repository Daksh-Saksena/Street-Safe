...
## Components
It uses an ESP32 S3 MINI 1U as the microcontroller.  
...
Were using stencils since its our first time working with pcbs. This pcb contains tightly packed components, so we recommend this aswell. Please refer to youtube tutorials aswell.
